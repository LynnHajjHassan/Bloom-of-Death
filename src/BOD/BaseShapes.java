...
class SquareShape extends BaseShapes {
	public SquareShape() {
...
class CylinderShape extends BaseShapes {
	...
	protected Node create_Object() {
		app = Commons.set_Appearance(Commons.Orange);   // set the appearance for the base
		return new Cylinder(0.12f, 1.0f, Primitive.GENERATE_NORMALS | Primitive.GENERATE_TEXTURE_COORDS, 30, 30, app);
	}
}

class SphereShape extends BaseShapes {
	public SphereShape() {
		Transform3D translator = new Transform3D();
	...
	protected Node create_Object() {
		app = Commons.set_Appearance(Commons.Red);   // set the appearance for the base
		return new Sphere(0.12f, Primitive.GENERATE_NORMALS | Primitive.GENERATE_TEXTURE_COORDS, 30, app);
	}
}

class SquareShape2 extends BaseShapes {
	public SquareShape2() {
		Transform3D translator = new Transform3D();
	...
	protected Node create_Object() {
		app = Commons.set_Appearance(Commons.Cyan);   // set the appearance for the base
		return new Box(0.26f, 0.06f, 0.12f, Primitive.GENERATE_NORMALS, app);
	}
}

class RotorBlades extends BaseShapes {
    public RotorBlades() {
        ...
        Appearance sphereApp = Commons.set_Appearance(Commons.Red);
        ...
        Appearance bladeApp = Commons.set_Appearance(Commons.Magenta);
...
class CoordinateSystem extends BaseShapes {
    ...
    protected Node create_Object() {
        ...
        ColoringAttributes xColor = new ColoringAttributes(Commons.Red, ColoringAttributes.SHADE_FLAT);
        ...
        ColoringAttributes yColor = new ColoringAttributes(Commons.Green, ColoringAttributes.SHADE_FLAT);
        ...
        ColoringAttributes zColor = new ColoringAttributes(Commons.Blue, ColoringAttributes.SHADE_FLAT);
...
class ColorString extends BaseShapes {
	private String str;
	private Color3f clr;
	private double scl;
