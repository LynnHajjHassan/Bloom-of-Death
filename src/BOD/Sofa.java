...
public class Sofa {
    ...
    protected static TransformGroup create_Sofa() {
...
class SofaMain extends BODObjects {
    ...
    public SofaMain() {
        ...
        post = new Vector3f(43.00f, -12.4f, 14f);                  // Position of the sofa
    ...
    protected void create_Appearance() {
    	...
    	setShininess(8.0f) ;
    	//mtl.setShininess(8.0f); // Shininess (float) — how concentrated or broad the specular highlight is.		mtl DOES NOT EXIST IN MAIN CODE
        obj_Appearance();
