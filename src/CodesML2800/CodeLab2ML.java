...
public class CodeLab2ML extends JPanel implements ActionListener {

	private static final long serialVersionUID = 1L;
	private static JFrame frame;
	
	private static String frame_name = "ML's Lab #2";
	...
	private static BranchGroup create_Scene() {
		...
		groupObject = new GroupObjects(L2StarML.line_Shape(0.6f)); 
	...
	public CodeLab2ML(BranchGroup scene) {
		...
		CommonsML.define_Viewer(su, new Point3d(1.35, -0.35, 1.5)); 		
	...
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new CodeLab2ML(create_Scene()));
	...
	public void actionPerformed(ActionEvent e) {
		...
		case OBJECT_NAME:                                  // change object shape and name
			if (object_tag) {
				groupObject = new GroupObjects(L2StarML.line_Shape(0.3f));
