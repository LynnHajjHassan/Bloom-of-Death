...
public class CommonsML extends JPanel {
	...
	public CommonsML(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new CommonsML(create_Scene()));  // create an instance of the class
