...
public class L4TransformML extends GroupObjects {
	...
	public static Shape3D ring_Side(int shape_key, Color3f clr) {
		...
		Point3f c_pts[] = L2StarML.circle_Points(0, r, MAX_PTS);                
		Point3f ctr_pt = new Point3f(0f, 0f, 0.1f);
		Point3f ctr_pt2 = new Point3f(0f, 0f, -0.1f);    // centre of 
		Point3f p1, p2;
	...
	public L4TransformML(int key) {
		super(ring_Side(key, CommonsML.Green));
	}
}