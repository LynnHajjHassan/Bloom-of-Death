...
public class L9MorphShapeML {
	...
	public static Morph set_Morph(TransformGroup parentTG, String s, int n0, int n1, int n2) {
		...
		Morph morph = new Morph(geoArray, L5TextureSurfaceML.set_Appearance(s));
		...
		mBeh.setSchedulingBounds(CommonsML.twenty_BS);     // enable morphing behavior with a scheduling bound
	...
	private static TriangleStripArray ring_Side(String shape_key, int num) {
		...
		Point3f c_pts[] = L2StarML.circle_Points(0, r, M_PTS);
