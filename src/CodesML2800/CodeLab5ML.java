...
public class CodeLab5ML extends JPanel implements ActionListener {

	private static final long serialVersionUID = 1L;
	private static JFrame frame;
	
	private static String frame_name = "ML's Lab #5";
	...
	private int[] sides = {4, 8 ,12, 16} ;  //sides
	private int i = 1 ; 
	...
	private static BranchGroup create_Scene() {
		...
		groupObject = new GroupObjects(L5TextureSurfaceML.round_Table(4));
	...
	public CodeLab5ML(BranchGroup scene) {
	...
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new CodeLab5ML(create_Scene()));
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Pause/Rotate":
			...
			return;
		case OBJECT_NAME:			//different sides
			groupObject = new GroupObjects(L5TextureSurfaceML.round_Table(sides[i]));
			frame.setTitle(frame_name + ": "+ sides[i] +"-Sided Table");
			i++ ; 
			if (i == 4) i = 0 ; 
			break;
		default:
