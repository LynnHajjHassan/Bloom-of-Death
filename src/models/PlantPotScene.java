...
public class PlantPotScene {

    public PlantPotScene() {}

    // === NEW === returns the plant's main TransformGroup for use in scene & collision
    public static TransformGroup getPlantPotTG() {
        // Load and texture the plant parts.
        BranchGroup potBG   = loadOBJWithTexture("objects/pot.obj",   "textures/pot_texture.jpg");
        BranchGroup soilBG  = loadOBJWithTexture("objects/soil.obj",  "textures/soil_texture.jpg");
        BranchGroup leafBG  = loadOBJWithTexture("objects/leaf.obj",  "textures/leaf_texture.jpg");
        ...
        leafTrans.setTranslation(new Vector3f(0f, 3.0f, 0.5f));
        Transform3D leafScale = new Transform3D();
        leafScale.setScale(3.5f);
        ...
        customTransform.setScale(3.5f);
        customTransform.setTranslation(new Vector3f(-1.0f, -15f, -93.0f));
        plantPositionTG.setTransform(customTransform);
        plantPositionTG.addChild(plantTG);
        ...
        plantPositionTG.setBounds(bounds);

        return plantPositionTG;
    }

    // === Unchanged === for optional standalone usage (includes background)
    public static BranchGroup createPlantPotBG() {
        BranchGroup sceneRoot = new BranchGroup();
        sceneRoot.addChild(getPlantPotTG());
