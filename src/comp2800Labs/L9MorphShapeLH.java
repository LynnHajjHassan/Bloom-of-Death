...
public class L9MorphShapeLH {
	...
	public static Morph set_Morph(TransformGroup parentTG, String s, int n0, int n1, int n2) {  // NEW: Made the function accept an extra number n2
		
		// int[] num = {n0, M_PTS, n1};                       // set edge number: 'n0' starting; 'n1' ending // NEW: Commented this line 
		
		// NEW: Made a new array of points, each point will represent ( example ) : 4 <-> 16 <-> 8, in this case n0 = 1 , n1= 16, n2= 8  
		int[] num = {n0, n1, n2}; 
		...
		Morph morph = new Morph(geoArray, L5TextureSurfaceLH.set_Appearance(s));
		...
		mBeh.setSchedulingBounds(CommonsLH.twenty_BS);     // enable morphing behavior with a scheduling bound
	...
	private static TriangleStripArray ring_Side(String shape_key, int num) {
		...
		Point3f c_pts[] = L2StarLH.circle_Points(0, r, M_PTS);
		Point3f ctr_pt = new Point3f(0f, 0f, 0.1f);
		Point3f p1, p2;
		Point3f ctr_pt2 = new Point3f(0f, 0f, -0.1f);   // NEW: create another center point for the bottom part 
