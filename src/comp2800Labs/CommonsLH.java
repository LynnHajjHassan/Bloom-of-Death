...
public class CommonsLH extends JPanel {
	...
	public CommonsLH(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("LH's Common File");            // NOTE: change XY to student's initials
		frame.getContentPane().add(new CommonsLH(create_Scene()));  // create an instance of the class
