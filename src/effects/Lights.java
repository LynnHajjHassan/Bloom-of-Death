...
public class Lights {
	...
	public static void setupSceneEffects(TransformGroup sceneTG) {
	    // Add stronger ambient light (bright white)
	    AmbientLight ambientLight = createAmbientLight(new Color3f(0.3f, 0.3f, 0.3f), 200.0);  // Brighter intensity
	    sceneTG.addChild(ambientLight);

	    // Add a stronger directional light (bright white and more intense direction)
	    DirectionalLight directionalLight = createDirectionalLight(
	        new Color3f(1.0f, 1.0f, 1.0f), // Bright white light
	        new Vector3f(-1.0f, -1.0f, -0.5f), // Light direction
	        200.0 // Increased radius for stronger effect
	    );
